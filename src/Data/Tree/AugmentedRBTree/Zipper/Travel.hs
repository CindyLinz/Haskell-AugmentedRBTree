...
upZipper (Zipper _ StepFirst) = Nothing
...
backLastLeftZipper (Zipper _ StepFirst) = Nothing
...
backLastRightZipper (Zipper _ StepFirst) = Nothing
...
mostUpZipper z@(Zipper _ StepFirst) = z
